...
exports.AIResultPanel = void 0;
const vscode = __importStar(require("vscode"));
// ============================================================
// AI Result Panel — Beautiful webview for displaying AI output
// ============================================================
class AIResultPanel {
    static show(context, title, content, providerLabel, featureIcon) {
        ...
        const panel = vscode.window.createWebviewPanel('projectCodeWizAI', `🧠 ${title}`, column, {
            enableScripts: true,
            retainContextWhenHidden: true,
        });
        AIResultPanel.currentPanel = new AIResultPanel(panel, title, content, providerLabel, featureIcon);
    }
    constructor(panel, title, content, providerLabel, featureIcon) {
        this._disposables = [];
        this._panel = panel;
        this._panel.onDidDispose(() => this.dispose(), null, this._disposables);
        this._panel.webview.html = this.getHtml(title, content, providerLabel, featureIcon);
    }
    update(title, content, providerLabel, featureIcon) {
        this._panel.title = `🧠 ${title}`;
        this._panel.webview.html = this.getHtml(title, content, providerLabel, featureIcon);
    }
    getHtml(title, content, providerLabel, featureIcon) {
...
exports.AIResultPanel = AIResultPanel;
